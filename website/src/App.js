...
export default function App() {
    return (
        <div className="App w-[100dvw] h-[100dvh] flex justify-center bg-sage-green">
            <div className={"flex flex-col w-full h-auto max-w-[1152px] px-12 mobile:px-5 bg-cream py-5 border-x-2 border-black gap-4"}>
                <div className={"flex flex-col gap-2"}>
                    <p className={"text-3xl font-bold"}>Notes Nook</p>
